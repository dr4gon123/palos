...
The first four columns of `panos_ecs_mapping.csv` (`Variable Name`, `Field Name`, `Log Types`, `PAN-OS Description`) come directly from `11.1+/consolidated/panos_consolidated_fields.csv`, which is generated by the scraper. After re-scraping or applying variable name corrections, copy the updated rows from `panos_consolidated_fields.csv` into the mapping file, then re-apply or extend the ECS columns manually.
